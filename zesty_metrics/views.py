...
TRANSPARENT_1X1_PNG = (
    ...
    b"\x00\x00\x00\x01\x00\x00\x00\x01\x08\x03\x00\x00\x00\x28\xcb\x34"
    b"\xbb\x00\x00\x00\x19\x74\x45\x58\x74\x53\x6f\x66\x74\x77\x61\x72"
    b"\x65\x00\x41\x64\x6f\x62\x65\x20\x49\x6d\x61\x67\x65\x52\x65\x61"
    b"\x64\x79\x71\xc9\x65\x3c\x00\x00\x00\x06\x50\x4c\x54\x45\x00\x00"
    b"\x00\x00\x00\x00\xa5\x67\xb9\xcf\x00\x00\x00\x01\x74\x52\x4e\x53"
    b"\x00\x40\xe6\xd8\x66\x00\x00\x00\x0c\x49\x44\x41\x54\x78\xda\x62"
    b"\x60\x00\x08\x30\x00\x00\x02\x00\x01\x4f\x6d\x59\xe1\x00\x00\x00"
    b"\x00\x49\x45\x4e\x44\xae\x42\x60\x82\x00")
...
class StatView(ProcessFormView, FormMixin):
    ...
    def send_stat(self, form):
        ...
        if stat_data is not None:
            for name, value in sorted(stat_data.items()):
                handler(name, **value)
